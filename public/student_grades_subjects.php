...
<script type="text/javascript">
  $(function(){
    ...
    $("#grid_grades_subjects").jqGrid({
        url:'student_grades_subjects_xml.php?student_id=<?php echo $student_id; ?>' ,
        datatype: 'xml',
        mtype: 'GET',
        colNames:['ACTION','ID', 'SUBJECT CODE', 'SUBJECT DESCRIPTION','GRADE','UNITS', 'YEAR', 'SEMESTER', 'REMARKS'],
        colModel :[
          ...
          {name:'semester', index:'semester', width:70, align:'left', sortable:true, editable:false},
